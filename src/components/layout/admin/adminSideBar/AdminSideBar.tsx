...
export function AdminSideBar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-30 flex w-72 shrink-0 flex-col bg-brgy-navy transition-transform lg:static ${
      ...
      >
        ...
        <button
          type="button"
          aria-label="Close sidebar"
          className="absolute right-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-md border border-white/20 bg-brgy-navy-mid text-brgy-gold"
          onClick={onClose}
        >
